...
function normalizeOptions(tree, setupOptions) {
    var _a, _b, _c;
    return Object.assign(Object.assign({}, setupOptions), { projectName: (_a = setupOptions.projectName) !== null && _a !== void 0 ? _a : (0, devkit_1.readNxJson)(tree).defaultProject, targetName: (_b = setupOptions.targetName) !== null && _b !== void 0 ? _b : 'docker-build', buildTarget: (_c = setupOptions.buildTarget) !== null && _c !== void 0 ? _c : 'build' });
}
...
function updateProjectConfig(tree, options) {
    let projectConfig = (0, devkit_1.readProjectConfiguration)(tree, options.projectName);
    projectConfig.targets[`${options.targetName}`] = {
        dependsOn: [`${options.buildTarget}`],
        executor: 'nx:run-commands',
        options: {
            commands: [
                `docker build -f ${(0, devkit_1.joinPathFragments)(projectConfig.root, 'Dockerfile')} .`,
            ],
        },
    };

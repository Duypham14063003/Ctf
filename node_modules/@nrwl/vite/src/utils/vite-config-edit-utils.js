    ...
    if (buildNode.length) {
        ...
        if (foundDefineConfig.length) {
            ...
            try {
                ...
                const found = _tsquery.tsquery.query(defaultExport == null ? void 0 : defaultExport[0], 'ObjectLiteralExpression');
...
function handleCacheDirNode(appFileContent, cacheDir) {
    const file = _tsquery.tsquery.ast(appFileContent);
    const cacheDirNode = _tsquery.tsquery.query(file, 'PropertyAssignment:has(Identifier[name="cacheDir"])');
